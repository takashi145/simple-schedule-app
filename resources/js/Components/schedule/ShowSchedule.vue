...
const deleteSchedule = () => {
  form.delete(route('schedule.delete', {'schedule' : props.schedule.id }), {
  ...
  >
    <div class="m-3 p-4">
      ...
      <div class="text-end border-t pt-3 space-x-4">
        <button class="text-white bg-indigo-400 hover:bg-indigo-600 px-4 py-2 rounded shadow-lg">編集</button>
